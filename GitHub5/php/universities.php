<?php
  switch($_POST['op']) {
    case 'country':
      ...
      try {
        $dbh = new PDO('mysql:host=localhost;dbname=universities', 'root', '', array(PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION));
    ...
    case 'university':
      $result = array("list" => array());
      try {
        $dbh = new PDO('mysql:host=localhost;dbname=universities', 'root', '',
